...
Hooks.once("init", function() {
  ...
  console.log("Vagabond | Registering VagabondCharacterSheet");
  ...
  console.log("Vagabond | Registering VagabondNPCSheet");
  ...
  console.log("Vagabond | Sheets registered");
  ...
  console.log("Vagabond | Initialization complete");
});
...
async function preloadHandlebarsTemplates() {
  const templatePaths = [
    ...
    "systems/vagabond/templates/actor/character-sheet.hbs",
